---
title: Hardware Guide - Building Your Physical AI Lab
sidebar_position: 15
---

# Hardware Guide: Building Your Physical AI Lab

## Overview

This course is technically demanding, sitting at the intersection of Physics Simulation (Isaac Sim/Gazebo), Visual Perception (SLAM/Computer Vision), and Generative AI (LLMs/VLA). This guide will help you choose and budget for appropriate robotics hardware based on your needs and financial constraints.
...
Simulating in the cloud works well, but controlling a real robot from a cloud instance is dangerous due to latency. Solution: Students train in the Cloud, then download to a local Jetson Orin for real-time control.